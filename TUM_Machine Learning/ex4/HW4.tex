...
regression}\label{task-1-fit-standard-linear-regression}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{fit\PYZus{}least\PYZus{}squares}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{c+c1}{\PYZsh{} TODO}
            \PY{n}{w} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{X}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{p}{,}\PY{n}{y}\PY{p}{)}
            \PY{k}{return} \PY{n}{w}
\end{Verbatim}
...
regression}\label{task-2-fit-ridge-regression}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{def} \PY{n+nf}{fit\PYZus{}ridge}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{reg\PYZus{}strength}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{} TODO}
             \PY{n}{w} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{X}\PY{p}{)}\PY{o}{+}\PY{n}{reg\PYZus{}strength}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{n}{X}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{p}{,}\PY{n}{y}\PY{p}{)}
             \PY{k}{return} \PY{n}{w}
\end{Verbatim}
...
data}\label{task-3-generate-predictions-for-new-data}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{def} \PY{n+nf}{predict\PYZus{}linear\PYZus{}model}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{w}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{} TODO}
             \PY{n}{y} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{w}\PY{p}{)}
             \PY{k}{return} \PY{n}{y}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{k}{def} \PY{n+nf}{mean\PYZus{}squared\PYZus{}error}\PY{p}{(}\PY{n}{y\PYZus{}true}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{} TODO}
             \PY{n}{mse} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{square}\PY{p}{(}\PY{n}{y\PYZus{}true}\PY{o}{\PYZhy{}}\PY{n}{y\PYZus{}pred}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{y\PYZus{}pred}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
reference soultion due to numerical reasons.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} Load the data}
...
MSE for Ridge regression = 21.05148703377112
...
\exercise
Let's assume T is a diagonal matrix, where:
\[
T
=
\begin{bmatrix}
...
\end{bmatrix}
\]
Then, a $E_{weighted}$ can be rewrite as:
$$E_{weighted} = (\phi w -y)^TT(\phi w -y)=(w^T \phi^T -y^T)T(\phi w -y)=$$
$$=(w^T \phi^TT -y^TT)(\phi w -y)=(w^T \phi^TT\phi w-w^T\phi^TTy-y^TT\phi w +y^TTy)$$
We can rid of $y^TTy$, because it is constant and doesn't affects minimizing E i.r.t w. 
$$=w^T \phi^TT\phi-2y^TT\phi w$$
To find minimum of this functions, we can find a derivative and equal it to 0.
$$w^T\phi^TT\phi - y^TT\phi=0$$
$$w^T\phi^TT\phi = y^TT\phi$$
$$\phi^TT\phi w=\phi^TTy$$
$$w=(\phi^TT\phi)^{-1}\phi^TTy$$
1) If we can expect high variance in some data, we can use weighting factor $t_i$ to to reduce the impact of some data on the weight function (for example, distrustful data) and increase the impact of some data on the weight function (trustful data). \newline
2) If we have a lot of repeatable data (with the same samples and labels) we can reduce it's affect for weight function by decreasing weighting factor  $t_i$ for some value (the easiest way - equal it to $\frac{1}{n}$, where n - is amount of this data in dataset).
